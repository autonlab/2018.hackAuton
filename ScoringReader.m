...
csvwrite('time_tot.csv', time_tot)
csvwrite('duration.csv', duration)
%eval (['save micro_str.csv' file(1:end-4) ' time_tot duration type_ar start_time'])
%eval (['save hyp.csv' file(1:end-4) ' hyp'])